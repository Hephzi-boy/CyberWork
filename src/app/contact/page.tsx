      ...
      <section className="hero-banner hero-banner--compact hero-banner--contact">
        <div className="hero-banner__veil hero-banner__veil--flat" />
          ...
          <div className="hero-banner__copy hero-banner__copy--wide">
            ...
            <p>Technical, strategic, and operational conversations start here.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container-shell contact-layout">
          <div className="contact-form-card">
            ...
            <div className="visual-chip-row">
              <span className="visual-chip"><span className="material-symbols-outlined">support_agent</span> Demo</span>
              <span className="visual-chip"><span className="material-symbols-outlined">analytics</span> Research</span>
              <span className="visual-chip"><span className="material-symbols-outlined">handshake</span> Partnership</span>
            </div>
          ...
          <aside className="contact-sidebar">
            <div className="contact-map-card">
              ...
              <div className="contact-map-card__body">
                ...
                <div className="contact-map-card__meta">
                  ...
                  <span>{leadDepartment?.department ?? "Security Operations"} leads monitoring</span>
                </div>
              </div>
            </div>
            ...
            <div className="urgent-card">
              <div>
                ...
                <p>{metrics.highRiskEmployees} cases need analyst review.</p>
              </div>
